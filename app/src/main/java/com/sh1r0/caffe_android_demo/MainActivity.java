...
//                "/sdcard/caffe_mobile/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel");
        caffeMobile.loadModel("/sdcard/caffe_mobile/model60000/deploy_mobile.prototxt",
                "/sdcard/caffe_mobile/model60000/finetune_flickr_style_iter_1001.caffemodel");


        AssetManager am = this.getAssets();
        try {
//            InputStream is = am.open("synset_words.txt");
            InputStream is = am.open("try.txt");
